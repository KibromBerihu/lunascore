...
class Configuration(object):
    def __init__(self) -> None:
        ...
        # Working directory
        self.WORKDIR = Path("E:\lunascore\lunascore")
        ...
        self.DATADIR = Path("E:\lunascore\extraced_final\luna25_nodule_blocks\luna25_nodule_blocks")
        # Path to the folder containing the CSVs for training and validation.
        self.CSV_DIR = Path("E:\lunascore\lunascore\data")
        ...
        self.EXPERIMENT_NAME = "lunascore"
