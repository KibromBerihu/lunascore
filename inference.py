...
INPUT_PATH = Path("E:/lunascore/lunascore/test/input")
OUTPUT_PATH = Path("E:/lunascore/results")
RESOURCE_PATH = Path("E:/lunascore/lunascore/resources")
...
class NoduleProcessor:
    def __init__(self, ct_image_file, nodule_locations, clinical_information, mode="2D", model_name="lunasscore-2D"):
        """
        Parameters
        ----------
...
def run(mode="2D", model_name="lunascore"):
    # Read the inputs
