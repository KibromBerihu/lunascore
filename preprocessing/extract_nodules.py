...
if __name__ == "__main__":
    ...
    extractor = NoduleExtractor(
        csv_path=Path(
            "G:\Data\luna25/LUNA25_Public_Training_Development_Data.csv"
        ),
        image_root=Path("E:\lunascore\extraced_final\luna25_images\luna25_images"),
        output_path=Path("E:\lunascore\output"),
        postfix="_0000",
        save_format=".nii.gz",
    )
